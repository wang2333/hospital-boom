    ...
    try:
        ...
        if icon_leave_message:
            ...
            if TEL_NAME:
                ...
                leaveword_input = tab.ele('@class:leaveword-textarea')
                leaveword_input.input('你好，我想沟通咨询下，我的电话是18259606013，微信和手机号一样，电话要是打不通你加我微信哈')
            callback = tab.ele('@class:leaveword-submit')
            if callback:
                callback.click(by_js=True)
                tab.ele('@class:imlp-component-typebox-input pc-imlp-component-typebox-input').input('你好')
                time.sleep(0.5)
                ...
                tab.ele('@class:imlp-component-typebox-input pc-imlp-component-typebox-input').input('微信和电话都是18259606013')
                time.sleep(0.5)
                tab.ele('@class:imlp-component-typebox-send-btn pc-imlp-component-typebox-send ').click(by_js=True)
